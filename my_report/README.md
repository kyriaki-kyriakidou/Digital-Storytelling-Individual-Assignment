...
Μέσα στις διαφανείς επιφάνειες των φωτιστικών έχουν τοποθετηθεί point lights για να φωτίζουν την πόλη σε περίπτωση αλλαγής του directional light. Με παρόμοια λογική τοποθετήθηκαν φωτά και στις “σκεπές” των κτηρίων. Στα φωτά που είναι τοποθετημένα στον τοίχο προτιμήθηκε η επιλογή των spotlights. Αυτές οι προσθήκες έχουν ως αποτέλεσμα την παρακάτω εικόνα: 
